    ...
    <div v-if="article" class="min-h-screen">
        ...
        <div class="px-4 sm:px-6 mt-5 sm:mt-6 md:px-10 lg:px-20 xl:px-32 pb-12 sm:pb-16">
            <div class="grid grid-cols-1 lg:grid-cols-12 gap-6 sm:gap-8">
                                ...
                                <div class="flex gap-3 sm:gap-4 items-start">
                                    ...
                                    <div class="flex-1 min-w-0">
                                        ...
                                        <div
                                            ...
                                            <span>{{ currentLang === 'id' ? related.date.id : related.date.en }}</span>
                                            <span class="w-1 h-1 bg-gray-400 rounded-full"></span>
                                            <span>1 MENIT</span>
                                        </div>
                                        <h4
                                            class="font-bold text-sm sm:text-base text-[#1a0f0a] group-hover:text-[#2C1810] transition-colors duration-300 line-clamp-2 mb-1.5 sm:mb-2">
                ...
                <!-- Right Sidebar (Popular Articles) - Sticky & Responsive -->
                <div class="lg:col-span-4 hidden lg:block">
                    <div class="sticky" style="top: 120px;">
                        <div class="bg-white rounded-2xl shadow-lg p-6">
                            <!-- Header with Icon -->
                            <div class="flex items-center gap-3 mb-6">
                                <div class="p-2 bg-[#2C1810]/10 rounded-lg">
                                ...
                                <h3 class="text-xl font-bold text-[#1a0f0a]">Artikel Populer</h3>
                            </div>
                            <p class="text-sm text-gray-600 mb-6">Yang banyak dibaca</p>
                            ...
                            <div class="space-y-3">
                                <article v-for="(popular, index) in popularArticles" :key="popular.id"
                                    ...
                                    <div
                                        ...
                                        <!-- Thumbnail -->
                                        <div class="flex-shrink-0 w-24 h-20 rounded-xl overflow-hidden bg-gray-100">
                                        ...
                                        <div class="flex-1 min-w-0">
                                            ...
                                            <h4
                                                class="font-bold text-sm text-[#1a0f0a] group-hover:text-[#2C1810] transition-colors duration-300 line-clamp-2 mb-1">
