        ...
        <div class="px-4 sm:px-6 md:px-10 lg:px-20 xl:px-32  sm:py-12 w-full h-full">
            <div class="flex w-full flex-col">
                ...
                <div class="mt-4 sm:mt-5 flex flex-col lg:flex-row lg:gap-8 xl:gap-12">
                    <div class="flex-1">
                        <h1 class="text-3xl sm:text-4xl md:text-5xl leading-tight sm:leading-[1.1] max-w-full lg:max-w-150 text-[#1a1a1a]" style="font-weight: 700;">
                            Studio Interior &
                    ...
                    <div class="flex-1 flex flex-col mt-6 lg:mt-0 text-md sm:text-md font-thin space-y-3 sm:space-y-1.5 text-[#6b6b6b]">
                        ...
                        <p>Dengan tim profesional yang berdedikasi, kami fokus pada kualitas material, detail
                            pengerjaan, dan desain fungsional yang disesuaikan dengan kebutuhan dan budget klien.
                        </p>
                        <p>Kepuasan klien adalah prioritas utama kami. Setiap proyek ditangani dengan perhatian penuh
                            dari tahap konsultasi, desain, produksi, hingga instalasi.
                        </p>
                    </div>
                </div>
            </div>
